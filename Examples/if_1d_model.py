#
# Generated: 2018-01-12 19:40:01.536755
#
import math
import numpy as np
import torch
...
class model(interface):
	...
	Arcs A:
	  (f20004, cond_20003), (cond_20003, y20005), (cond_20003, c20002), (f20004, c20002), (cond_20003, y20006), (y20005, c20002), (x20001, f20004), (x20001, c20002), (y20006, c20002)
	...
	Observed values O:
	  ...
	  y20006 -> 1
	"""
	vertices = {'y20005', 'c20002', 'y20006', 'f20004', 'cond_20003', 'x20001'}
	arcs = {('f20004', 'cond_20003'), ('cond_20003', 'y20005'), ('cond_20003', 'c20002'), ('f20004', 'c20002'), ('cond_20003', 'y20006'), ('y20005', 'c20002'), ('x20001', 'f20004'), ('x20001', 'c20002'), ('y20006', 'c20002')}
	names = {'x20001': 'x'}
	cond_functions = {
	  'cond_20003': 'f20004',
	...
	def gen_pdf(self, state):
		...
		f20004 = -x20001
		cond_20003 = (f20004 >= 0).data[0] # this was missing
		cond_20003 = state['cond_20003']
		dist_y20005 = dist.Normal(mu=1, sigma=1.0)
		p10001 = dist_y20005.log_pdf(1) if not cond_20003 else vc(0,grad=True) #added vc
		dist_y20006 = dist.Normal(mu=-1, sigma=1.0)
		p10002 = dist_y20006.log_pdf(1) if cond_20003 else vc(0, grad=True) #added the vc
