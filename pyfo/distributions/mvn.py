...
class MultivariateNormal(TorchDistribution):
    ...
    def __init__(self, loc, covariance_matrix=None, precision_matrix=None,  scale_tril=None, validate_args=None):
        self.loc = vc(loc)
        self.scale = torch.sqrt(vc(covariance_matrix))
        torch_dist = torch.distributions.MultivariateNormal(loc=self.loc, covariance_matrix=self.scale)
        super(MultivariateNormal, self).__init__(torch_dist)
