...
project = u'pyfo'
copyright = u'2018, Bradley Gram-Hansen ; Tobias Kohn ; Yuan Zhou'
author = u'Bradley Gram-Hansen ; Tobias Kohn ; Yuan Zhou'
...
latex_documents = [
    (master_doc, 'pyfo.tex', u'pyfo Documentation',
     u'Bradley Gram-Hansen ; Tobias Kohn ; Yuan Zhou', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyfo', u'pyfo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyfo', 'pyfo Documentation',
     author, 'pyfo', 'One line description of project.',
     'Miscellaneous'),
]
